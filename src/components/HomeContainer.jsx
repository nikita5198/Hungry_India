...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum dolorem accusantium tempora magni cumque aliquid ea. Ex, reiciendis nam. Optio unde iure excepturi dolor fuga reprehenderit praesentium deleniti, quia aliquid!
      </p>
    ...
    <div className='py-2  flex-1 flex items-center relative'>
      ...
      <div className='w-full h-full absolute top-0 left-0 flex items-center  justify-center lg:pr-48 py-4 gap-4 flex-wrap'>
        {heroData && heroData.map(n=>(
          ...
          <img src={n.imageSrc} className='w-20 lg:w-40 -mt-10 lg:-mt-20' alt="Ice-cream"/>
